...
-----------------------------------------
DEMO-ONLY mock carrier tracking API.

This file simulates the carrier tracking lookup used by the
portfolio prototype.

It does NOT connect to a real carrier, database, authentication,
...
@app.get("/carrier/tracking")
def get_tracking():
    """Return deterministic mock carrier tracking data."""
    ...
    mock_order = DEMO_TRACKING.get(order_id)
